...
public class GameConstants
{
  ...
  public static final double SMALL_ASTEROID_RADIUS = 10;
  public static final double MEDIUM_ASTEROID_RADIUS = 20;
  public static final double LARGE_ASTEROID_RADIUS = 30;
  public static final int SMALL_ASTEROID_POINTS = 50;
  public static final int MEDIUM_ASTEROID_POINTS = 100;
  public static final int LARGE_ASTEROID_POINTS = 200;
  public static final int ASTEROID_SPEED = 1;

  public static final int SAUCER_WIDTH = 10;
  public static final int SAUCER_HEIGHT = 5;
